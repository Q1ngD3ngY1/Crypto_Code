...
#数据
Task_data_4 = [4000,125,174,76,2000,
               ...
               4000,125,174,76,2000,
               4000,125,174,76,2000]
#Task_data_4 = (7000,120,170,50,1500)

#扰动
alpha_4 = [22,68,43,10,16,
           22,68,43,10,16,
           22,68,43,10,16,
           22,68,43,10,16,
           22,68,43,10,16,
...
def perb_data_gen():
    ...
    for m in range(TASK_NUM):
        perb_data_4.append(Task_data_4[m] - alpha_4[m])
    return perb_data_4
'''[6938, 56, 151, 32, 1480]
...
def pai_encrypt_data():
    ...
    for m in range(TASK_NUM):
        encrypted_data.append(pai.encipher(Task_data_4[m],paillier_public_key[0],paillier_public_key[1]))
...
def pai_encrypt_perb():
    ...
    pai = paillier_variant.Paillier()
    for m in range(TASK_NUM):
        encrypted_perbed.append(pai.encipher(alpha_4[m],paillier_public_key[0],paillier_public_key[1]))
...
'''
H_4j_1 = System_Params.hash_to_group(Identity_hash(U_ID[3]),q)
...
def main():
    ...
    #计算MAC
    z_4 = 12345678911
    s = str(aes_enc_perbed_data) + str(aes_enc_pai_enc_task_data) + str(aes_enc_pai_enc_perb) + str(aes_enc_pai_enc_perbpowsum) + str(H_4j)
    mac = System_Params.MAC(s,z_4)
    ...
    print(mac)
    '''
    return aes_enc_perbed_data,aes_enc_pai_enc_task_data,aes_enc_pai_enc_perb,aes_enc_pai_enc_perbpowsum,H_4j,mac
#main()